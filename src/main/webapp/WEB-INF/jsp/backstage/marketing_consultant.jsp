...
<div class="layui-form" lay-filter="layuiadmin-form-useradmin" id="addForm" style="padding: 10px 0 0 0;display: none">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" lay-verify="required" placeholder="请输入名称" maxlength="20" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
...
<div class="layui-form" id="updateForm" style="padding: 10px 0 0 0;display: none">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">名称</label>
        <div class="layui-input-inline">
            <input type="text" name="name" id="name" lay-verify="required" placeholder="请输入名称" maxlength="20"
    ...
    layui.config({
        ...
        $('#deletes').on('click', function () {
            ...
            layer.confirm('确定要删除信息', function (index) {
                ...
                $.ajax({
                    url: '/marketing/consultant/deletes/' + ids,
                    type: "get",
                    success: function (result) {
                        if (result.code == 200) {
        ...
        table.on('tool(table)', function (obj) {
            ...
            if (layEvent === 'del') {  //删除
                layer.confirm('真的删除行么', function (index) {
                    //向服务端发送删除指令
                    $.ajax({
                        url: '/marketing/consultant/deletes/' + data.id,
                        type: "get",
                        success: function (result) {
                            if (result.code == 200) {
                                layer.msg('已删除');
                ...
                form.on('submit(updateSubmit)', function (data) {
                    ...
                    $.ajax({
                        url: '/marketing/consultant/update',
                        type: "post",
                        data: field,
                        dataType: "json",
                        async: false,
