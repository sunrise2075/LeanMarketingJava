...
<div class="layui-form" lay-filter="layuiadmin-form-useradmin" id="addForm" style="padding: 10px 0 0 0;display: none">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="introduction" lay-verify="required" placeholder="请输入新闻简介" class="layui-textarea"></textarea>
        </div>
    </div>
...
<div class="layui-form" id="updateForm" style="padding: 10px 0 0 0;display: none">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">新闻标题</label>
        <div class="layui-input-inline">
            <input type="text" name="title" id="title" lay-verify="required" placeholder="请输入新闻标题" autocomplete="off"
                   class="layui-input">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">新闻简介</label>
        <div class="layui-input-block">
            <textarea name="introduction" id="introduction" lay-verify="required" placeholder="请输入新闻简介"
    ...
    layui.config({
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'id', title: 'ID'},
                {field: 'title', title: '新闻标题', minWidth: 200},
                {field: 'introduction', title: '新闻简介', minWidth: 200},
                {
                    field: 'headPortrait', title: '新闻封面图',
                    templet: function (d) {
                        if (d.coverImg != '') {
                ...
                {field: 'description', title: '新闻描述', minWidth: 200},
                {
                    field: 'createTime',
                    minWidth: 200,
                    title: '创建时间',
