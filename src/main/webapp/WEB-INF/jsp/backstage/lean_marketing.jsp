...
<div class="layui-form" lay-filter="layuiadmin-form-useradmin" id="addForm" style="padding: 10px 0 0 0;display: none">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" lay-verify="required" placeholder="请输入名称,最多输入20字" maxlength="20"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="title" lay-verify="required" placeholder="请输入标题,最多输入20字" maxlength="20"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="introduction" lay-verify="required" placeholder="请输入简介" class="layui-textarea"></textarea>
        </div>
    </div>
...
<div class="layui-form" id="updateForm" style="padding: 10px 0 0 0;display: none">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">名称</label>
        <div class="layui-input-inline">
            <input type="text" name="name" id="name" lay-verify="required" placeholder="请输入名称,最多输入20字" maxlength="20"
                   autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">标题</label>
        <div class="layui-input-inline">
            <input type="text" name="title" id="title" lay-verify="required" placeholder="请输入标题,最多输入20字" maxlength="20"
                   autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">简介</label>
        <div class="layui-input-block">
            <textarea name="introduction" id="introduction" lay-verify="required" placeholder="请输入简介"
    ...
    layui.config({
        ...
        $('#deletes').on('click', function () {
            ...
            layer.confirm('确定要删除信息', function (index) {
                ...
                $.ajax({
                    url: '/lean/marketing/deletes/' + ids,
                    type: "get",
                    success: function (result) {
                        if (result.code == 200) {
        ...
        table.on('tool(table)', function (obj) {
            ...
            if (layEvent === 'del') {  //删除
                layer.confirm('真的删除行么', function (index) {
                    //向服务端发送删除指令
                    $.ajax({
                        url: '/lean/marketing/deletes/' + data.id,
                        type: "get",
                        success: function (result) {
                            if (result.code == 200) {
                                layer.msg('已删除');
